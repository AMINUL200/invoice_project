// pages/admin/companies/create.jsx
import React, { useState } from 'react';
import { ArrowLeft, Save, Building2, Mail, Phone, MapPin, Globe, Users, CreditCard } from 'lucide-react';
      ...
      <header className="bg-white border-b border-[#E2E8F0] sticky top-0 z-10">
        <div className="px-8 py-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-[#0F172A]">Add New Company</h1>
              <p className="text-sm text-[#64748B] mt-1">
                Create a new company in your SaaS platform
              </p>
            </div>
          </div>
        </div>
      ...
      <main className="p-8">
        <form onSubmit={handleSubmit} className="max-w-3xl mx-auto">
          <div className="bg-white rounded-xl border border-[#E2E8F0] shadow-sm overflow-hidden">
            ...
            <div className="p-6 border-b border-[#E2E8F0]">
              <h2 className="text-lg font-semibold text-[#0F172A] mb-4">Subscription Details</h2>
